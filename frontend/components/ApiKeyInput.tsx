...
export type Provider = "groq" | "gemini" | "cerebras" | "openrouter" | "anthropic" | "openai";
...
export const PROVIDERS: {
  ...
  { id: "cerebras",    label: "Cerebras",    free: true,  model: "Llama 3.3 70B",    url: "https://cloud.cerebras.ai",              color: "from-yellow-500 to-orange-400" },
