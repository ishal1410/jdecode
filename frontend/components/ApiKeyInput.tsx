...
export type Provider = "groq" | "gemini" | "huggingface" | "openrouter" | "anthropic" | "openai";
...
export const PROVIDERS: {
  ...
  { id: "huggingface", label: "HuggingFace", free: true,  model: "Llama 3.3 70B",    url: "https://huggingface.co/settings/tokens", color: "from-yellow-500 to-orange-400" },
